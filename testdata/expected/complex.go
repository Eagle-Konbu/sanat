...
// UserRepository exercises a wider surface of the scanner and formatter than
// basic.go: multiple methods, context-aware driver calls, and a broader mix
// of SQL statement shapes.
